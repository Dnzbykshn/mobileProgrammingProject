...
async def extract_milestone_memory(
    ...
    """
    Extract a progress milestone memory when user completes a journey.

    Called from plan_service when user completes a 7-day journey.
    """
    ...
    print(f"✅ Created milestone memory for plan {plan_id}")
    return memory.id
