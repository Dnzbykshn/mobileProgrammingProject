...
export interface Memory {
  id: string;
  user_id: string;
  memory_type: 'emotional_state' | 'life_event' | 'spiritual_preference' | 'goal' | 'progress_milestone' | 'behavioral_pattern';
  content: string;
...
export const MEMORY_TYPE_CONFIG = {
  emotional_state: {
    ...
    bgColor: '#1E3A8A', // blue-900/30
  },
  life_event: {
    icon: '📍' as const,
    label: 'Yaşam Olayı',
    color: '#FBBF24', // amber-400
    bgColor: '#78350F', // amber-900/30
  },
  spiritual_preference: {
    icon: '✨' as const,
    label: 'Manevi Tercih',
    color: '#5EEAD4', // teal-300
    bgColor: '#134E4A', // teal-900/30
  },
  goal: {
    icon: '🎯' as const,
    label: 'Hedef',
    color: '#A78BFA', // violet-400
    bgColor: '#4C1D95', // violet-900/30
  },
  progress_milestone: {
    icon: '🏆' as const,
    label: 'Başarı',
    color: '#34D399', // emerald-400
    bgColor: '#064E3B', // emerald-900/30
  },
  behavioral_pattern: {
    icon: '⏰' as const,
    label: 'Alışkanlık',
    color: '#F472B6', // pink-400
    bgColor: '#831843', // pink-900/30
  },
} as const;
